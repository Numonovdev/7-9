function ModalDelete( {isOpen, onClose, onDelete,cardId}){
...
if (!isOpen) return null;
    ...
    return(
        ...
        <div className="w-[300px] text-black bg-white/90 rounded-xl flex p-5 flex-col gap-6 items-center">
            <h1 className="text-xl font-bold">{cardId.nameId}</h1>
            <p className="text-sm font-bold">Bu student ma`lumotlarini o`chirmoqchimisiz?</p>
